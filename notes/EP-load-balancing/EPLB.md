...
EPLB（Expert Parallelism Load Balancer）是 DeepSeek 开源的 EP 负载均衡算法。它用历史 Expert 负载低频准备布局，避免长期热点集中在少数 GPU。本文依据仓库中的 `parallel/load-balancing/eplb.py`。
